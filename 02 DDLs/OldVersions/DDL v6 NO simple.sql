...
GO
/****** Object:  Schema [admin]    Script Date: 5/10/2025 15:54:22 ******/
CREATE SCHEMA [admin]
GO
/****** Object:  Schema [auction]    Script Date: 5/10/2025 15:54:22 ******/
CREATE SCHEMA [auction]
GO
/****** Object:  Schema [audit]    Script Date: 5/10/2025 15:54:22 ******/
CREATE SCHEMA [audit]
GO
/****** Object:  Schema [core]    Script Date: 5/10/2025 15:54:22 ******/
CREATE SCHEMA [core]
GO
/****** Object:  Schema [finance]    Script Date: 5/10/2025 15:54:22 ******/
CREATE SCHEMA [finance]
GO
/****** Object:  Schema [nft]    Script Date: 5/10/2025 15:54:22 ******/
CREATE SCHEMA [nft]
GO
/****** Object:  Schema [ops]    Script Date: 5/10/2025 15:54:22 ******/
CREATE SCHEMA [ops]
GO
/****** Object:  Table [admin].[CurationReview]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [auction].[Auction]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [auction].[AuctionSettings]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [auction].[Bid]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [audit].[EmailOutbox]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [core].[Role]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [core].[User]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [core].[UserEmail]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [core].[UserRole]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [core].[Wallet]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [nft].[NFTSettings]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [nft].[NFTSettings](
	...
	[CreatedAtUtc] [datetime2](3) NOT NULL,
 CONSTRAINT [PK_NFTSettings] PRIMARY KEY CLUSTERED 
(
	[SettingsID] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
) ON [PRIMARY]
GO
/****** Object:  Table [finance].[FundsReservation]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [finance].[Ledger]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [nft].[NFT]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [nft].[NFT](
 ...
 CONSTRAINT [PK__NFT__5A8CBCFA9EAAD917] PRIMARY KEY CLUSTERED 
(
	[NFTId] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY],
...
GO
/****** Object:  Table [ops].[Settings]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [ops].[Status]    Script Date: 5/10/2025 15:54:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [nft].[NFT] ADD  CONSTRAINT [DF__NFT__StatusCode__5812160E]  DEFAULT ('PENDING') FOR [StatusCode]
GO
ALTER TABLE [nft].[NFT] ADD  CONSTRAINT [DF__NFT__CreatedAtUt__59063A47]  DEFAULT (sysutcdatetime()) FOR [CreatedAtUtc]
GO
...
GO
ALTER TABLE [admin].[CurationReview]  WITH CHECK ADD  CONSTRAINT [FK_CReview_Status] FOREIGN KEY([StatusDomain], [DecisionCode])
REFERENCES [ops].[Status] ([Domain], [Code])
GO
ALTER TABLE [admin].[CurationReview] CHECK CONSTRAINT [FK_CReview_Status]
GO
...
GO
ALTER TABLE [auction].[Auction]  WITH CHECK ADD  CONSTRAINT [FK_Auction_Settings] FOREIGN KEY([SettingsID])
REFERENCES [auction].[AuctionSettings] ([SettingsID])
GO
ALTER TABLE [auction].[Auction] CHECK CONSTRAINT [FK_Auction_Settings]
GO
...
GO
ALTER TABLE [nft].[NFT]  WITH CHECK ADD  CONSTRAINT [FK_NFT_NFTSettings] FOREIGN KEY([SettingsID])
REFERENCES [nft].[NFTSettings] ([SettingsID])
GO
ALTER TABLE [nft].[NFT] CHECK CONSTRAINT [FK_NFT_NFTSettings]
GO
...
GO
ALTER TABLE [finance].[Ledger]  WITH CHECK ADD  CONSTRAINT [CK_Ledger_Type] CHECK  (([EntryType]='DEBIT' OR [EntryType]='CREDIT'))
GO
